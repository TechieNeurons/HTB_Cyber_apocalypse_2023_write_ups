...
mine = [] # I store the result here
for i in range(77):
    mine.append(m1[i] ^ t[i])

print (mine) # I want to see what's in the variable
# we get this : [66, 117, 116, 32, 116, 104, 101, 32, 118, 97, 108, 117, 101, 32, 111, 102, 32, 116, 104, 101, 115, 101, 32, 115, 104, 101, 108, 108, 115, 32, 119, 105, 108, 108, 32, 102, 97, 108, 108, 44, 32, 100, 117, 101, 32, 116, 111, 32, 116, 104, 101, 32, 108, 97, 119, 115, 32, 111, 102, 32, 115, 117, 112, 112, 108, 121, 32, 97, 110, 100, 32, 100, 101, 109, 97, 110, 100]

# I create a variable which will contain the char of the mine variable, and a loop to put every char in the variable
password = ''
for i in mine:
    password += chr(i)

print (password)
# We get : "But the value of these shells will fall, due to the laws of supply and demand"
